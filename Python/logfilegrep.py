...
id=firewall time="2016-01-14 05:11:15" fw=sledge2.fnmoc.navy.mil pri=3 proto=110/tcp 
src=192.168.39.45 srcname= dst=192.168.1.1 dstname= msg="Netprobe event detected."
id=firewall time="2016-01-14 09:30:41" fw=sledge2.fnmoc.navy.mil pri=3 proto=25/tcp 
src=192.168.25.31 srcname= dst=192.168.1.1 dstname= msg="Netprobe event detected."
id=firewall time="2016-01-14 09:30:41" fw=sledge2.fnmoc.navy.mil pri=3 proto=60000/tcp 
src=192.168.25.31 srcname= dst=192.168.1.1 dstname= msg="Netprobe event detected."
</pre>
